...
using MVCAttempt2.Models;

namespace MVCAttempt2.Controllers
{
    public class TicketOptionsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Category,TeamName,Eurl,League,Esource,Id")] TicketOptions ticketOptions)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Category,TeamName,Eurl,League,Esource,Id")] TicketOptions ticketOptions)
        {
